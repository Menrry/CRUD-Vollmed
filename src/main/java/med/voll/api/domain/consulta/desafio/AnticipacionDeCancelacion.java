...
@Component
public class AnticipacionDeCancelacion implements ValidadorCancelaConsulta {
    @Autowired
    ...
    public void validar(DatosCancelacionDeConsulta datos){
        ...
        if (diferenciaEnHoras < 24){
            throw new ValidationException("Consulta solamente puede ser cancelar con antecedencia minima de 24 horas");
        }
